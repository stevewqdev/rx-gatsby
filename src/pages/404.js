                ...
                <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 right no__padding  d-flex justify-content-center  flex-column ">
                  ...
                  >
                    <svg
                      ...
                      width="320.041"
                      height="475.16"
                      viewBox="0 0 320.041 475.16"
                    >
                      <g
                        id="Grupo_329"
                        data-name="Grupo 329"
                        transform="translate(-2022.974 171.411)"
                      >
                        <g
                          id="Grupo_329-2"
                          data-name="Grupo 329"
                        ...
                        >
                          <path
                            ...
                            d="M2259.624-95.11l-63.479,45.032,63.479,45.032V71.241L2141.3-12.711,2022.974,68.745V-6.765l62.912-43.313-62.912-43.313v-75.524L2141.3-87.446l118.324-83.966Z"
                            transform="translate(-2022.974 171.411)"
                            fill="#f4f4f4"
                          />
                        </g>
                        <path
                          ...
                          d="M2239.486,122.879a32.468,32.468,0,1,0,32.481,32.468,32.254,32.254,0,0,0-32.481-32.468Z"
                          transform="translate(71.048 113.604)"
                          fill="#f4f4f4"
                        />
                        <path
                          id="Trazado_93"
                          data-name="Trazado 93"
                          d="M2144.1,85.033c63.382,0,121.126,51.173,121.13,119.722h-59.153c0-39.439-28.647-64.784-61.977-64.784s-61.957,25.345-61.961,64.784h-59.161c0-68.549,57.747-119.722,121.122-119.722Z"
                          transform="translate(0 98.994)"
                          fill="#f4f4f4"
                        />
                      </g>
                    </svg>
