        ...
        <div className="project__template in-13">
          ...
          <div className="main__section__wrapper">
                    ...
                    >
                      <h1
                        ...
                        dangerouslySetInnerHTML={{
                          __html: pageAcf.investigation_about,
                        }}
                      />
                    </div>
                  </div>
            ...
            <div className="single__project" id="single__three">
              <div className="container container__custom">
                <div className={`row`}>
                  {pageAcf.investigation_section_three_content.map(
                    (element, index) => (
                      <>
                        {index === 0 ? (
                          <>
                            ...
                            >
                              <Img
                                ...
                                alt={`Illustration from Investigation 13 project`}
                                tabIndex={-1}
                              />
                            </div>
                          </>
                        ...
                        {index === 5 ? (
                          <>
                            <div
                              className={`custom__col col-xs-12 col-sm-12 col-md-6 col-lg-6 col-two-${index} image `}
                              key={index}
                              data-aos="fade-up"
                              data-aos-easing="ease-in-back"
                              data-aos-delay={`120`}
                        ...
                        {index === 6 ? (
                          <>
                            <div
                              className={`col-xs-12 col-sm-12 col-md-6 col-lg-6 copy no__padding col-two-${index}`}
                              data-aos="fade-up"
                              data-aos-easing="ease-in-back"
                              data-aos-delay={`120`}
                              data-aos-duration="1200"
