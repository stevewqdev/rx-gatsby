...
import "../../layouts/pages/projects/investigation-13.css"
import Vimeo from '@u-wave/react-vimeo';
import RelatedProjects from "../../components/relatedProjects/index"

class Investigation13 extends Component {
    constructor(props) {
        super(props);
          ...
          <div className="main__section__wrapper">
            <div className="single__project" id="single__one">
                <div className="container container__custom">
                    <div className={`row`} >
                        {
                            pageAcf.investigation_sone_gallery.map((image, index) => 
                        ...
                        {
                            pageAcf.investigation_vimeo_id  
                            ? 
                                ...
                                <div className="the__video" onClick={this.playVideo}>
                                    ...
                                    <Vimeo
                                    video={pageAcf.investigation_vimeo_id}
                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 full__width__image no__padding about">
                            ...
                            >
                                <h1
                                    ...
                                    className="xxl__font"
                                    dangerouslySetInnerHTML={{ __html: pageAcf.investigation_about }}
                                />
                            </div>
                        </div>
                    </div>
            ...
            <div className="single__project" id="single__three">
                <div className="container container__custom">
                    <div className={`row`} >
                        {
                            pageAcf.investigation_section_three_content.map((element, index) => 
                                <>
                                {
                                    index === 0
                                    ?
                                    <>
                                    <div className={`custom__col col-xs-12 col-sm-12 col-md-3 col-lg-3 col-two-${index} image no__padding`} key={index}
                                                                        data-aos="fade-up"
                                                                        data-aos-easing="ease-in-back"
                                                                        data-aos-delay={`120`}
                                                                        data-aos-duration="1200"
                                ...
                                }
                                {
                                    ...
                                    ?
                                    <>
                                    <div className={`custom__col col-xs-12 col-sm-12 col-md-6 col-lg-6 col-two-${index} image `} key={index}
                                                                        data-aos="fade-up"
                                                                        data-aos-easing="ease-in-back"
                                                                        data-aos-delay={`120`}
                                                                        data-aos-duration="1200"
                                ...
                                }
                                {
                                    ...
                                    ?
                                    <>
                                    <div className={`col-xs-12 col-sm-12 col-md-6 col-lg-6 copy no__padding col-two-${index}`}
                                                                        data-aos="fade-up"
                                                                        data-aos-easing="ease-in-back"
                                                                        data-aos-delay={`120`}
                                                                        data-aos-duration="1200"
...
export default Investigation13

export const pageQuery = graphql`
query Investigation13PageQuery {
    allWordpressWpProjects(filter: {wordpress_id: {eq: 1075}}) {
      edges {
        node {
          id
          title
          ...
          acf {
            ...
            project_background
            investigation_sone_gallery
            investigation_vimeo_id
            investigation_about
            investigation_section_three_content{
                image{
                    localFile {
                        childImageSharp {
                        fluid(maxWidth: 1300, quality: 80) {
