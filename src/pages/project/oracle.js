                  ...
                  {pageAcf.oracle_section_one_content.map((element, index) => (
                    <>
                      {index === 0 ? (
                        <>
                          <div
                            className={`custom__col col-xs-12 col-sm-12 col-md-12 col-lg-12 copy no__padding col-one-${index}`}
                            data-aos="fade-up"
                          ...
                          <div
                            className={`custom__col col-xs-12 col-sm-12 col-md-6 col-lg-6 col-one-${index} image no__padding`}
                            key={index}
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                      ...
                      {index === 2 ? (
                        <>
                          <div
                            className={`custom__col col-xs-12 col-sm-12 col-md-9 col-lg-9 col-one-${index} image no__padding`}
                            key={index}
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                          ...
                          <div
                            className={`custom__col col-xs-12 col-sm-12 col-md-3 col-lg-3 copy d-flex  align-items-center col-one-${index}`}
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                      ...
                      {index === 3 ? (
                        <>
                          <div
                            className={`custom__col col-xs-12 col-sm-12 col-md-12 col-lg-12 col-one-${index} no__padding image`}
                            key={index}
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                      ...
                      {index === 4 ? (
                        <>
                          <div
                            className={`custom__col col-xs-12 col-sm-12 col-md-3 col-lg-3 d-flex  align-items-center copy col-one-${index}`}
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                          ...
                          <div
                            className={`custom__col col-xs-12 col-sm-12 col-md-9 col-lg-9 col-one-${index} no__padding image`}
                            key={index}
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                      ...
                      {index === 5 ? (
                        <>
                          <div
                            className={`custom__col col-xs-12 col-sm-12 col-md-9 col-lg-9 col-one-${index} image `}
                            key={index}
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                      ...
                      {index === 6 ? (
                        <>
                          <div
                            className={`custom__col col-xs-12 col-sm-12 col-md-3 col-lg-3 d-flex  align-items-center copy no__padding col-one-${index}`}
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
