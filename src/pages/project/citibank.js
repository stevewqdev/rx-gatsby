          ...
          <div className="main__section__wrapper">
            <div className="single__project" id="single__one">
              <div className="container container__custom">
                <div className={`row `}>
                  {pageAcf.citibank_section_one_content.map(
                    (element, index) => (
                      <>
                        {index === 0 ? (
                          <>
                            <div
                              className="col-xs-12 col-sm-12 col-md-12 col-lg-12 copy no__padding  d-flex align-items-start"
                              key={index}
                              data-aos="fade-up"
                            ...
                            >
                              <Img
                                ...
                                alt={`Illustration from Citibank project`}
                                tabIndex={-1}
                              />
                            </div>
                          </>
                ...
                {pageAcf.citibank_section_one_content.map((element, index) => (
                  <>
                    ...
                    {index === 4 ? (
                      <div className={`row row-${index} `} key={index}>
                        <div
                          className="col-xs-12 col-sm-12 col-md-12 col-lg-12 copy no__padding d-flex align-items-end justify-content-end"
                          data-aos="fade-up"
                          data-aos-easing="ease-in-back"
                          data-aos-delay={`120`}
                          data-aos-duration="1200"
