      ...
      <Layout>
        <div className="project__template kindur">
          ...
          <div className="main__section__wrapper">
                    ...
                    pageAcf.kind_first_section_content.map((element, index) => 
                      <>
                      {
                        ...
                        <>
                          ...
                          <div className="image-one-0 col-xs-12 col-sm-12 col-md-12 col-lg-12 image mix-multiply no__padding"
                          data-aos="fade-up"
                          data-aos-easing="ease-in-back"
                          data-aos-delay={`120`}
                          data-aos-duration="1200"
                      ...
                      }
                      {
                        ...
                        ?
                        <>
                          <div className="image-one-4 col-xs-12 col-sm-12 col-md-12 col-lg-12 image mix-multiply no__padding"
                          data-aos="fade-up"
                          data-aos-easing="ease-in-back"
                          data-aos-delay={`120`}
                          data-aos-duration="1200"
                      ...
                      }
                      {
                        ...
                        <>
                          ...
                          <div className="image-one-5 col-xs-12 col-sm-12 col-md-12 col-lg-12 image mix-multiply no__padding"
                          data-aos="fade-up"
                          data-aos-easing="ease-in-back"
                          data-aos-delay={`120`}
                          data-aos-duration="1200"
                      ...
                      }
                      {
                        ...
                        <>
                          ...
                          <div className="image-one-6 col-xs-12 col-sm-12 col-md-3 col-lg-3 image mix-multiply no__padding"
                          data-aos="fade-up"
                          data-aos-easing="ease-in-back"
                          data-aos-delay={`120`}
                          data-aos-duration="1200"
                      ...
                      }
                      {
                        ...
                        <>
                          <div className="col-xs-12 col-sm-12 col-md-3 col-lg-3"></div>
                          <div className="image-one-7 col-xs-12 col-sm-12 col-md-3 col-lg-3 image mix-multiply no__padding"
                          data-aos="fade-up"
                          data-aos-easing="ease-in-back"
                          data-aos-delay={`120`}
                          data-aos-duration="1200"
                      ...
                      }
                      {
                        ...
                        <>
                          <div className="col-xs-12 col-sm-12 col-md-3 col-lg-3"></div>
                          <div className="col-xs-12 col-sm-12 col-md-3 col-lg-3"></div>
                          <div className="image-one-8 col-xs-12 col-sm-12 col-md-3 col-lg-3 image mix-multiply no__padding"
                          data-aos="fade-up"
                          data-aos-easing="ease-in-back"
                          data-aos-delay={`120`}
                          data-aos-duration="1200"
            ...
            <div className="single__project includes__separator" id="single__three">
                <div className="container container__custom">
                    <div className="row ">
                      ...
                      >
                        <div
                          className="simple__copy sm__font reg__font"
                          dangerouslySetInnerHTML={{ __html: pageAcf.kind_main_copy }}
                        />
                      </div>
