        ...
        <div className="project__template ">
          ...
          <div className="main__section__wrapper">
            ...
            <section id="section__two">
                <div className="container container__custom">
                    <div className="row">
                        <div className=" col-lg-12 video__wrapper"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                ...
                <div className="container container__custom">
                    <div className="row">
                        ...
                        </div>
                        {
                            ...
                            <div className={`col-xs-12 col-sm-12 col-md-12 col-lg-3 section__three__image-${index}`}
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                    ...
                    <div className="row gallery">
                        {
                            ...
                            className={
                                `col-xs-12 col-sm-12 
                                ${index === 0 || index === 1 ? "col-md-6 col-lg-6" : ""} 
            ...
            <section id="section-four">
                <div className="container container__custom">
                    <row>
                        <div className="no__padding col-lg-12 copy"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                ...
                <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 full__width__image ">
                  ...
                  >
                    <h1
                        ...
                        className="xxl__font"
                        dangerouslySetInnerHTML={{ __html: pageAcf.sfour_about }}
                    />
                  </div>
                </div>
              </div>
                ...
                <div className="row gallery">
                    {
                        pageAcf.sfive_gallery.map((image,index) => 
                            ...
                            className={
                                ...
                                ${index === 1 || index === 2 ? "col-md-6 col-lg-6" : ""} 
                                section__three__image-${index}
          ...
          <section id="section__seven">
              <div className="container container__custom">
                <div className="row two__columns">
                    <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 image no__padding "
                        data-aos="fade-up"
                        data-aos-easing="ease-in-back"
                        data-aos-delay={`120`}
                        data-aos-duration="1200"
