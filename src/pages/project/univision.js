          ...
          <div className="main__section__wrapper">
            <div className="single__project" id="single__one">
                <div className="container container__custom">
                    <div className="row one">
                        <div className="column__custom col-xs-12 col-sm-12 col-md-12 col-lg-12 copy no__padding d-flex align-items-end justify-content-end"
                                                            data-aos="fade-up"
                        ...
                        >
                            ...
                            dangerouslySetInnerHTML={{ __html: pageAcf.univision_copy }}
                            />
                        </div>
                        ...
                        <div className=" col-xs-12 col-sm-12 col-md-12 col-lg-12 full__width__image no__padding about">
                            ...
                            >
                                <h1
                                    ...
                                    className="xxl__font"
                                    dangerouslySetInnerHTML={{ __html: pageAcf.univision_about }}
                                />
                            </div>
                        </div>
                    </div>
            ...
            <div className="single__project " id="single__three">
                <div className="container container__custom">
                    <div className={`row`} >
                    {
                        pageAcf.univision_section_three_content.map((element, index) => 
                            <>
                                {
                                    index === 0 
                                    ?
                                ...
                                }
                                {
                                    ...
                                    ?
                                    <>
                                        <div className={`column__custom col-xs-12 col-sm-12 col-md-12 col-lg-12 copy d-flex align-items-center no__padding`}
                                                                            data-aos="fade-up"
                                                                            data-aos-easing="ease-in-back"
                                                                            data-aos-delay={`120`}
                                                                            data-aos-duration="1200"
                            ...
                            <>
                                {
                                    ...
                                    ?   
                                    <>
                                        <div className={`column__custom col-xs-12 col-sm-12 col-md-6 col-lg-6 image no__padding`}
                                                                            data-aos="fade-up"
                                                                            data-aos-easing="ease-in-back"
                                                                            data-aos-delay={`120`}
                                                                            data-aos-duration="1200"
                        ...
                        pageAcf.univision_section_three_content.map((element, index) => 
                            <>
                                ...
                                }
                                {
                                    ...
                                    ?   
                                    <>
                                        <div className={`column__custom col-xs-12 col-sm-12 col-md-3 col-lg-3 copy copy-${index} d-flex align-items-center no__padding`}
                                                                            data-aos="fade-up"
                                    data-aos-easing="ease-in-back"
                                    data-aos-delay={`120`}
                                    data-aos-duration="1200"
