        ...
        <div className="project__template ray-d">
          ...
          <div className="main__section__wrapper">
            <div className="single__project" id="single__one">
              <div className="container container__custom">
                <div className="row one">
                  <div
                    className="column__custom col-xs-12 col-sm-12 col-md-6 col-lg-6 copy no__padding d-flex align-items-center"
                    data-aos="fade-up"
                  ...
                  >
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: pageAcf.ray_donovan_copy,
                      }}
                    />
                  </div>
                  ...
                  <div className=" col-xs-12 col-sm-12 col-md-12 col-lg-12 full__width__image no__padding about">
                    ...
                    >
                      <h1
                        className="xxl__font"
                        dangerouslySetInnerHTML={{
                          __html: pageAcf.ray_donovan_about,
                        }}
                      />
                    </div>
                  </div>
            ...
            <div className="single__project " id="single__three">
              <div className="container container__custom">
                <div className={`row`}>
                  {pageAcf.ray_donovan_section_three_content.map(
                    (element, index) => (
                      <>
                        {index === 0 || index === 1 ? (
                          <div
                          ...
                          >
                            <Img
                              ...
                              alt={`Illustration from Showtime project`}
                              tabIndex={-1}
                            />
                          </div>
                        ) : (
                      ...
                      {index === 2 ? (
                        <>
                          <div className={`row row-${index}`} key={index}>
                            ...
                            <div
                              className={`column__custom col-xs-12 col-sm-12 col-md-3 col-lg-3 copy d-flex align-items-center`}
                              data-aos="fade-up"
                              data-aos-easing="ease-in-back"
                              data-aos-delay={`120`}
                              data-aos-duration="1200"
                    ...
                    (element, index) => (
                      <>
                        ...
                        {index === 4 ? (
                          <>
                            <div
                              className="column__custom col-xs-12 col-sm-12 col-md-6 col-lg-6 copy d-flex align-items-center"
                              key={index}
                            ></div>
                            <div
                              className={` column__custom col-xs-12 col-sm-12 col-md-6 col-lg-6 image-${index} no__padding`}
