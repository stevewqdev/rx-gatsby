                        ...
                        <>
                          ...
                          >
                            <Img
                              ...
                              alt={`Illustration from Steelbridge project`}
                              tabIndex={-1}
                            />
                          </div>
                        </>
                  ...
                  {pageAcf.stb_two_content_section.map((element, index) => (
                    <>
                      ...
                      {index === 3 ? (
                        <>
                          <div
                            className="col-xs-12 col-sm-12 col-md-3 col-lg-3 copy  d-flex align-items-center no__padding"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                      ...
                      {index === 5 ? (
                        <>
                          <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-12 full__width__image image no__padding"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
