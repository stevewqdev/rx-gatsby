                ...
                {pageAcf.sermo_section_one_content.map((element, index) => (
                  <>
                      ...
                      <div className={`row one row-${index}`} key={index}>
                        ...
                        >
                          <Img
                            ...
                            alt={`Illustration from Sermo project`}
                            tabIndex={-1}
                          />
                        </div>
                      </div>
                    ...
                    {index === 3 ? (
                      <div className={`row one row-${index}`} key={index}>
                        <div
                          className="col-xs-12 col-sm-12 col-md-12 col-lg-12 copy d-flex justify-content-end align-items-end no__padding"
                          data-aos="fade-up"
                          data-aos-easing="ease-in-back"
                          data-aos-delay={`120`}
                          data-aos-duration="1200"
                ...
                {pageAcf.sermo_section_three_content.map((element, index) => (
                  <>
                    {index === 0 ? (
                      <div className={`row one row-${index}`} key={index}>
                        <div
                          className="col-xs-12 col-sm-12 col-md-12 col-lg-12 copy no__padding d-flex align-item-end justify-content-end"
                          data-aos="fade-up"
                          data-aos-easing="ease-in-back"
                          data-aos-delay={`120`}
                          data-aos-duration="1200"
                    ...
                    {index === 1 ? (
                      <div className={`row one row-${index}`} key={index}>
                        ...
                        <div
                          className="col-xs-12 col-sm-12 col-md-6 col-lg-6 copy "
                          data-aos="fade-up"
                          data-aos-easing="ease-in-back"
                          data-aos-delay={`120`}
                          data-aos-duration="1200"
