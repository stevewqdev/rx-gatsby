                    ...
                    <>
                      ...
                      <div
                        ...
                        className={`
                                    ...
                                    ${
                                      index === 5
                                        ? "col-md-3 col-lg-3 p-15"
                                        : ""
                                    }
                                    ${
                                      index === 6
                                        ? "col-md-3 col-lg-3 p-15 inverse"
                                        : ""
                                    }
                                    `}
                      >
                        <img
                          src={image}
                          alt="Illustration from BBC HD project"
                        />
                      </div>
                    </>
                  ))}
                    ...
                    <>
                      <div
                        ...
                        className={`
                                    ...
                                    ${
                                      index === 0
                                        ? "col-md-6 col-lg-6 p-15"
                                        : ""
                                    }
                                    ${
                                      index === 1
                                        ? "col-md-6 col-lg-6 p-15 inverse"
                                        : ""
                                    }
                    ...
                    >
                      <h1
                        ...
                        dangerouslySetInnerHTML={{
                          __html: pageAcf.bbchd_stwo_about,
                        }}
                      />
                    </div>
                  </div>
