                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 full__width__image no__padding about">
                            ...
                            >
                                <h1
                                    ...
                                    className="xxl__font"
                                    dangerouslySetInnerHTML={{ __html: pageAcf.bbce_stwo_about }}
                                />
                            </div>
                        </div>
                            ...
                            <>
                                ...
                                <div
                                    ...
                                    className={
                                        ...
                                        col-xs-12
                                        col-sm-12
                                        ${index === 0 ? "col-md-6 col-lg-6 mix-multiply p-15" : ""}
                                        ${index === 1 ? "col-md-6 col-lg-6 mix-multiply p-15 inverse" : ""}
                                        ${index === 2 ? "col-md-12 col-lg-12 mix-multiply" : ""}
                                        ${index === 3 ? "col-md-6 col-lg-6 mix-multiply p-15" : ""}
                                        ${index === 4 ? "col-md-6 col-lg-6 mix-multiply p-15 inverse" : ""}
                                        `
                                    }
                                >
