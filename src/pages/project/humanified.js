                      ...
                      <div key={index}>
                        ...
                        >
                          <Img
                            ...
                            alt={`Illustration from Humanified`}
                            tabIndex={-1}
                          />
                        </div>
                      ...
                      {index === 0 ? (
                        <>
                          <div
                            ...
                            data-aos-delay={`${(index + 1) * 100}`}
                            data-aos-duration="1200"
                            className={`humanified no__padding section__four__item col-xs-12 col-sm-12 col-md-9 col-lg-9
                      ...
                      {index === 1 ? (
                        <>
                          ...
                          <div
                            ...
                            data-aos-delay={`${(index + 1) * 100}`}
                            data-aos-duration="1200"
                            className={`humanified no__padding col-xs-12 col-sm-12 col-md-9 col-lg-9
                                    section__four__image-${index}
