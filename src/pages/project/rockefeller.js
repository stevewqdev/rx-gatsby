                  ...
                  {pageAcf.section_one_content.map((element, index) => (
                    <>
                        ...
                        <>
                          ...
                          >
                            <Img
                              ...
                              alt={`Illustration from Rockefeller project`}
                              tabIndex={-1}
                            />
                          </div>
                        </>
                      ...
                      {index === 3 ? (
                        <>
                          <div
                            className={`custom__col col-xs-12 col-sm-12 col-md-9 col-lg-9 col-two-${index} image no__padding`}
                            key={index}
                          >
                            <Img
                              fluid={
                          ...
                          <div
                            className={`custom__col col-xs-12 col-sm-12 col-md-3 col-lg-3 col-two-${index} copy `}
                            key={index}
                          >
                            <div
                              className="simple__copy sm__font reg__font"
                      ...
                      {index === 4 ? (
                        <>
                          <div
                            className={`custom__col col-xs-12 col-sm-12 col-md-3 col-lg-3 col-two-${index} no__padding copy `}
                            key={index}
                          >
                            <div
                              className="simple__copy sm__font reg__font"
