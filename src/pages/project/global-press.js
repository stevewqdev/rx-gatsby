...
class GlobalPress extends Component {
  render() {
    ...
    return (
      <Layout>
        <div className="project__template global-press">
          <Helmet>
            <meta charSet="utf-8" />
            <meta
              name="description"
          ...
          <div className="main__section__wrapper">
            <div className="single__project" id="single__one">
              <div className="container container__custom">
                {pageAcf.globapress_section_one_content.map(
                  (element, index) => (
                    <>
                      {index === 0 ? (
                        <>
                          <div className={`row row-${index}`}>
                            <div
                              className={`custom__col col-xs-12 col-sm-12 col-md-12 col-lg-12 col-two-${index} copy no__padding`}
                              key={index}
                              data-aos="fade-up"
                            ...
                            >
                              <Img
                                ...
                                alt={`Illustration from Global Press project`}
                                tabIndex={-1}
                              />
                            </div>
                          </div>
                  ...
                  <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 full__width__image no__padding about">
                    ...
                    >
                      <h1
                        className="xxl__font"
                        dangerouslySetInnerHTML={{
                          __html: pageAcf.globapress_about,
                        }}
                      />
                    </div>
                  </div>
            ...
            <div className="single__project" id="single__three">
              <div className="container container__custom">
                {pageAcf.globapress_section_three_content.map(
                  (element, index) => (
                    <>
                      {index === 0 ? (
                        <>
                          <div className={`row row-${index}`}>
                            <div
                              className={`custom__col col-xs-12 col-sm-12 col-md-12 col-lg-12 col-three-${index} copy no__padding`}
                              key={index}
                              data-aos="fade-up"
                              data-aos-easing="ease-in-back"
                              data-aos-delay={`120`}
                            ...
                            <div
                              className={`custom__col col-xs-12 col-sm-12 col-md-12 col-lg-12 col-three-${index} image no__padding`}
                              key={index}
                              data-aos="fade-up"
                              data-aos-easing="ease-in-back"
                              data-aos-delay={`120`}
                      ...
                      {index === 1 ? (
                        <>
                          <div className={`row row-${index}`}>
                            <div
                              className={`custom__col col-xs-12 col-sm-12 col-md-9 col-lg-9 col-three-${index} image no__padding`}
                              key={index}
                              data-aos="fade-up"
                              data-aos-easing="ease-in-back"
                              data-aos-delay={`120`}
                            ...
                            <div
                              className={`custom__col col-xs-12 col-sm-12 col-md-3 col-lg-3 col-three-${index} copy `}
                              key={index}
                              data-aos="fade-up"
                              data-aos-easing="ease-in-back"
                              data-aos-delay={`120`}
...
export const pageQuery = graphql`
  query GlobalPressPageQuery {
    allWordpressWpProjects(filter: { wordpress_id: { eq: 1074 } }) {
      edges {
        node {
          id
          title
          ...
          acf {
            ...
            project_background
            globapress_section_one_content {
              image {
                localFile {
                  childImageSharp {
                    fluid(maxWidth: 1300, quality: 80) {
            ...
            globapress_about
            globapress_section_three_content {
              image {
                localFile {
                  childImageSharp {
                    fluid(maxWidth: 1300, quality: 80) {
