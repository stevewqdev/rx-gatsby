...
class STM extends Component {
  render() {
    ...
    return (
      <Layout>
        <div className="project__template stm">
          <Helmet>
            <meta charSet="utf-8" />
            <meta
              name="description"
                  ...
                  {pageAcf.layern_section_two_content.map((element, index) => (
                    <>
                      ...
                      {index === 1 ? (
                        <>
                          <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-12 full__width__image no__padding mix-multiply"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                      ...
                      {index === 2 ? (
                        <>
                          <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-12 row-second full__width__image image no__padding mix-multiply"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                      ...
                      {index === 3 ? (
                        <>
                            <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-9 image no__padding row-third"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                            ...
                            <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-3 copy  d-flex align-items-center right"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                      ...
                      {index === 4 ? (
                        <>
                            <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-3 copy  d-flex align-items-center left"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
...
export const pageQuery = graphql`
  query STMPageQuery {
    allWordpressWpProjects(filter: { wordpress_id: { eq: 1899 } }) {
      edges {
        node {
          id
          title
