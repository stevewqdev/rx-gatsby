                        ...
                        <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 full__width__image no__padding about">
                            ...
                            >
                                <h1
                                    ...
                                    className="xxl__font"
                                    dangerouslySetInnerHTML={{ __html: pageAcf.sambazon_about }}
                                />
                            </div>
                        </div>
                    </div>
                    <div className="row second__gallery">
                        {
                            pageAcf.sambazon_stwo_gallery.map((image, index) => 
                                <>
                                {
                                    ...
                                    ?
                                    <>
                                    <div className={`custom__column no__padding col-two-${index} col-xs-12 col-sm-12 col-md-6 col-lg-6`}
                                                                        data-aos="fade-up"
                                                                        data-aos-easing="ease-in-back"
                                                                        data-aos-delay={`120`}
                                                                        data-aos-duration="1200"
                                ...
                                }
                                {
                                    ...
                                    ?
                                    <>
                                    <div className={`custom__column no__padding col-two-${index} col-xs-12 col-sm-12 col-md-12 col-lg-12`}
                                                                        data-aos="fade-up"
                                                                        data-aos-easing="ease-in-back"
                                                                        data-aos-delay={`120`}
                                                                        data-aos-duration="1200"
                                ...
                                }
                                {
                                    ...
                                    >
                                        ...
                                        dangerouslySetInnerHTML={{ __html: pageAcf.sambazon_gallery_copy }}
                                        />
                                    </div>
                                    </>
                                    :" "
                                }
                                {
                                    ...
                                    ?
                                    <>
                                    <div className={`custom__column no__padding col-xs-12 col-sm-12 col-md-6 col-lg-6 copy d-flex align-items-center`}>
