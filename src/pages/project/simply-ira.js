                  ...
                  {pageAcf.sy_first_content_section.map((element, index) => (
                    <>
                      {index === 0 ? (
                        <>
                          <div
                            className="col-xs-12 col-sm-6 col-md-6 col-lg-6 copy no__padding"
                            data-aos="fade-up"
                          ...
                          >
                            <Img
                              ...
                              alt={`Illustration from Simply Ira project`}
                              tabIndex={-1}
                            />
                          </div>
                          <div
                      ...
                      {index === 1 ? (
                        <>
                          <div
                            className="col-xs-12 col-sm-12 col-md-9 col-lg-9 copy no__padding"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                          ...
                          <div
                            className="col-xs-12 col-sm-12 col-md-3 col-lg-3 copy d-flex justify-content-center align-items-center "
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
