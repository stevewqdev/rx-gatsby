          ...
          <div className="main__section__wrapper">
            <div className="single__project" id="single__one">
              <div className="container container__custom">
                {pageAcf.the_department_section_one_content.map(
                  (element, index) => (
                    <>
                      {index === 0 ? (
                        <div
                          className={`row row-${index} image-one-${index} ${
                            index % 2 === 0 ? "basic" : "inverse"
                          }`}
                          key={index}
                        >
                          <div
                          ...
                          >
                            <Img
                              ...
                              alt={`The Department illustration of the work done`}
                              tabIndex={-1}
                            />
                          </div>
                        </div>
                      ...
                      {index === 1 ? (
                        ...
                        >
                          ...
                          <div
                            className="col-xs-12 col-sm-12 col-md-3 col-lg-3 copy  d-flex "
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                      ...
                      {index === 2 ? (
                        ...
                        >
                          <div
                            className="col-xs-12 col-sm-12 col-md-3 col-lg-3 copy no__padding d-flex "
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                    ...
                    >
                      <h1
                        ...
                        dangerouslySetInnerHTML={{
                          __html: pageAcf.the_department_about,
                        }}
                      />
                    </div>
                  </div>
            ...
            <div className="single__project " id="single__three">
              <div className="container container__custom">
                {pageAcf.the_department_section_three_content_copy.map(
                  (element, index) => (
                    <>
                      {index === 0 ? (
                        <div
                          className={`row row-${index} image-two-${index} `}
                          key={index}
                        >
                          <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-12 image no__padding"
