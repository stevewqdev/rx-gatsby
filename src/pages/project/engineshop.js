      ...
      <Layout>
        <div className="project__template ">
          ...
          <div className="main__section__wrapper">
            <section id="section__one" className="grid engineshop">
              <div className="container container__custom">
                <div className="row">
                      ...
                      <div key={index}>
                        ...
                        >
                          <Img
                            ...
                            alt={`Illustration from Engineshop project`}
                            tabIndex={-1}
                          />
                        </div>
                  ...
                  <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6 no__padding"></div>
                </div>
                <div className="row">
                  <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6 no__padding"></div>
                  <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6 no__padding left">
                ...
                <div className="row grid three">
                  <div
                    className="col-lg-12 no__padding"
                    data-aos="fade-up"
                    data-aos-easing="ease-in-back"
                    data-aos-delay={`120`}
                    data-aos-duration="1200"
                  >
                    <Img
                      fluid={pageAcf.grid_three.localFile.childImageSharp.fluid}
                      alt={`Illustration from Engineshop project`}
                      tabIndex={-1}
                    />
                  </div>
                ...
                <div className="row grid four">
                  <div
                    className="col-xs-12 col-sm-12 col-md-9 col-lg-9 no__padding"
                    data-aos="fade-up"
                    data-aos-easing="ease-in-back"
                    data-aos-delay={`120`}
                    data-aos-duration="1200"
                  >
                    <Img
                      fluid={pageAcf.grid_four.localFile.childImageSharp.fluid}
                      alt={`Illustration from Engineshop project`}
                      tabIndex={-1}
                    />
                  </div>
              ...
              <div className="container container__custom">
                <div className="row one">
                  ...
                  >
                    <Img
                      fluid={
                        pageAcf.sthree_image.localFile.childImageSharp.fluid
                      }
                      alt={`Illustration from Engineshop project`}
                      tabIndex={-1}
                    />
                      ...
                      {index === 0 ? (
                        <>
                          <div
                            ...
                            data-aos-duration="1200"
                            className={`no__padding section__four__item col-xs-12 col-sm-12 col-md-9 col-lg-9
            ...
            <section
              className="includes__separator humanified"
              id="section__two"
            >
              <div className="container container__custom">
