      ...
      <Layout>
        <div className="project__template ">
          ...
          <div className="main__section__wrapper rtw">
                  ...
                  {pageAcf.sone_gallery.map((element, index) => (
                    <>
                      {index === 0 || index === 1 ? (
                        <>
                          <div
                            className="col-xs-12 col-sm-12 col-md-6 col-lg-6 no__padding"
                            key={index}
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                      ...
                      {index === 2 ? (
                        <>
                          <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-12 no__padding image__3"
                            key={index}
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`${(index + 1) * 100}`}
            ...
            <section
              className="includes__separator rtw__about"
              id="section__two"
            >
              <div className="container container__custom">
                    ...
                    <>
                      {index % 2 === 0 ? (
                        <>
                          ...
                          <div
                            className="col-xs-12 col-sm-12 col-md-3 col-lg-3 image"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`160`}
                            data-aos-duration="1200"
