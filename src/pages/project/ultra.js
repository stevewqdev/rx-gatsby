                  ...
                  {pageAcf.ultra_sone_grid.map((element, index) => (
                    <>
                      {index === 0 ? (
                        <>
                          <div
                            className={`col-xs-12 col-sm-12 col-md-12 col-lg-12 copy hidden-${index} no__padding`}
                            data-aos="fade-up"
                      ...
                      {index === 1 ? (
                        <>
                          <div
                            className={`col-xs-12 col-sm-12 col-md-12 col-lg-12 copy hidden-${index} no__padding hidden`}
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                          ...
                          {element.image ? (
                            <>
                              <div
                                className={`col-xs-12 col-sm-12 col-md-12 col-lg-12 image hidden hidden-${index} no__padding`}
                                data-aos="fade-up"
                                data-aos-easing="ease-in-back"
                                data-aos-delay={`220`}
                                data-aos-duration="1200"
                      ...
                      {index === 2 ? (
                        <>
                          ...
                          {element.image ? (
                            <>
                              <div
                                className={`col-xs-12 col-sm-12 col-md-12 col-lg-12  image-${index} image hidden-${index} no__padding`}
                                data-aos="fade-up"
                                data-aos-easing="ease-in-back"
                                data-aos-delay={`220`}
                                data-aos-duration="1200"
                      ...
                      {index === 3 ? (
                        <>
                          <div
                            className={`col-xs-12 col-sm-12 col-md-12 col-lg-112 copy hidden-${index} d-flex justify-content-end no__padding`}
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                          ...
                          {element.image ? (
                            <>
                              <div
                                className={`col-xs-12 col-sm-12 col-md-12 col-lg-12 mix-multiply image hidden-${index} no__padding`}
                                data-aos="fade-up"
                                data-aos-easing="ease-in-back"
                                data-aos-delay={`220`}
                                data-aos-duration="1200"
              ...
              <div className="container container__custom">
                    ...
                    >
                      <h1
                        ...
                        dangerouslySetInnerHTML={{
                          __html: pageAcf.ultra_sone_about,
                        }}
                      />
                    </div>
                  </div>
                ...
                <div className="row two">
                  ...
                  >
                    <Img
                      fluid={
                        pageAcf.ultra_two_image.localFile.childImageSharp.fluid
                      }
                      alt={`Illustration from Ultra`}
                      tabIndex={-1}
                    />
                  ...
                  {pageAcf.ultra_three_grid.map((element, index) => (
                    <>
                      {index === 0 ? (
                        <>
                          <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-9 image no__padding"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                      ...
                      {index === 1 ? (
                        <>
                          <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-3 left copy no__padding"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                      ...
                      {index === 2 ? (
                        <>
                          <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-12 image no__padding mix-multiply"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                      ...
                      {index === 3 ? (
                        <>
                          <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-12 copy no__top d-flex justify-content-end "
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                      ...
                      {index === 4 ? (
                        <>
                          <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-3 copy left d-flex no__padding"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
                          ...
                          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-9  d-flex no__padding"></div>
                          <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-12 image floating__image no__padding"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`220`}
                            data-aos-duration="1200"
                      ...
                      {index === 6 ? (
                        <>
                          <div
                            className="col-xs-12 col-sm-12 col-md-12 col-lg-3 copy left no__padding"
                            data-aos="fade-up"
                            data-aos-easing="ease-in-back"
                            data-aos-delay={`120`}
                            data-aos-duration="1200"
