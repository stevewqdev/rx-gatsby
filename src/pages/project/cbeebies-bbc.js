              ...
              <div className="container container__custom">
                <div className="row one">
                  ...
                  <div className="col-lg-12 image no__padding">
                    <Img
                      fluid={
                        pageAcf.cbb_sone_image.localFile.childImageSharp.fluid
                      }
                      alt={`Illustration from Cbeebies project`}
                      tabIndex={-1}
                    />
                  </div>
                </div>
                  ...
                  {pageAcf.cbb_stwo_grid.map((element, index) => (
                    <>
                      ...
                      {index !== 0 && index % 2 === 0 ? (
                        <>
                          <div
                            className={`col-xs-12 col-sm-12 col-md-3 col-lg-3 copy hidden-${index}`}
                          >
                            <div
                              className="simple__copy sm__font reg__font"
                          ...
                          <div
                            className={`col-xs-12 col-sm-12 col-md-9 col-lg-9 image hidden-${index} no__padding`}
                          >
                            <Img
                              fluid={
                                element.main_image.localFile.childImageSharp
