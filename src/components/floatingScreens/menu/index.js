...
export default class MainMenuFloatingScreen extends Component {
    ...
    render() {
        return (
            <>
                <div className="container-fluid fixed menu__full__screen  floating__web__info  full__height sm__font" id="menu__full__screen">
                    <div className="row">
                        <div className="col-xs-12 col-sm-2 col-md-2 col-lg-2 brand relative" id="brand">
                        <div className="fixed">
                            <div className="brand__logo">
                                <img src={this.props.siteLogo.source_url} alt={this.props.siteLogo.title}/>
                            </div>
                            <div className="brand__menu bold__font ">
                                <div className="brand__menu__toggle --opened d-flex align-items-center" onClick={this.toggleMenu}>
                                     <svg xmlns="http://www.w3.org/2000/svg" width="23.309" height="30.775" viewBox="0 0 23.309 30.775">
                                    <g id="Grupo_102" data-name="Grupo 102" transform="translate(-23.99 -7448.256)">
                                        <path fill="#f4f4f4" id="Trazado_52" data-name="Trazado 52" d="M47.3,7448.256H44.929l-20.94,30.775h2.369Z"/>
                                        <path fill="#f4f4f4" id="Trazado_53" data-name="Trazado 53" d="M23.99,7448.256h2.369l20.94,30.775H44.929Z"/>
                                    </g>
                                    </svg>
                        ...
                        <div className="col-xs-6 col-sm-2 col-md-2 col-lg-2 relative copy__one__column xs__font reg__font">
                            <div className="absolute">
                                <p>
                                    {this.props.siteAcf.web_info_column_one}
                                </p>
                            </div>
                            <div className="copy__one__column__extra__menu">
                                <p class="md__font bold__font menu__section__title">
                                    Email Address
                                </p>
                        ...
                        <div className="col col-xs-6 col-sm-2 col-md-2 col-lg-2 relative copy__two__column xs__font reg__font">
                            <div className="absolute">
                                <p>
                                    {this.props.siteAcf.web_info_column_two}
                                </p>
                            </div>
                        </div>
                        <div className="col col-xs-12 col-sm-2 col-md-2 col-lg-2 relative copyright__column reg__font mobile-hidden" id="copyright__column">
                            <div className="fixed">
                                <p>
