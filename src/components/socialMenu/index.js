    ...
    <>
      {
        socialItems.map((network, index) =>
          <div 
            ...
            key={index}
          >
            <a href={`${network.network_link}`} onMouseOver={checkIfBodyIsLight} target="_BLANK" rel="noopener noreferrer">
                ...
                ? <>
                  {
                    ...
                    ? <img src={network.network_logo.source_url} alt={network.network_logo.title} />
                    : ""
                  }
                  </>
                : ""
