  ...
  render() {
    return (
        ...
        <div className="navContent">
          <div className="navbarMenuBurger show" onClick={this.toggleMenu}>
            <div className="menuBurger">
              <div data-aos="fade-right" data-duration="4000" className="menuBurgerLineOne" style={{width: '38px'}}></div>
              <div data-aos="fade-right" data-duration="4300" className="menuBurgerLineTwo" style={{width: '29px'}}></div>
            </div>
          </div>
      ...
      <div className="col-lg-12 categoriesMenu" id="categoriesMenu">
              <svg onClick={this.toggleMenu} id="toggleClose" width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="categories" className="blogCategories">
          <div className="row">
            ...
            <Link data-aos="fade-down" data-duration="4000" to="/add-culture/minority" onMouseEnter={this.showTooltip} onMouseLeave={this.hideTooltip} className="categorySelector text-muted" id="categoryOne">
